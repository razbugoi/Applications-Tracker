...
- Required repository secrets:
  - `SUPABASE_ACCESS_TOKEN` – personal access token with access to the project `kswjftmtiuwplqtdwqpn`.
  - `SUPABASE_DB_PASSWORD` – database password from the Supabase project settings.
